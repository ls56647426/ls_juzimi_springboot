...
@WebServlet("/sentence/ShowSentenceSortByNumbersOfLike")
public class ShowSentenceSortByNumbersOfLikeServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(res3 != null) {
			...
			//处理业务
			Page<Sentence> page = this.ss.findSentenceAllPageAndSort(start, 20, Direction.DESC, "numbersOfLike");
