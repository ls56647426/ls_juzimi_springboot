...
@WebServlet("/sentence/ShowSentenceSortByHotToday")
public class ShowSentenceSortByHotTodayServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("ShowSentenceSortByHotToday请求结果：" + uname + " " + upassword);
		//处理请求信息
		if(res3 != null) {
			//获取业务层对象
			...
			//处理业务
			//获取热度不为0的句子
			Page<Sentence> page = this.ss.findSentenceAllByHotToday(start, 20);
...
//			Gson gson = new Gson();
			...
			System.out.println("ShowSentenceSortByHotToday错误提示：res3 = null");
		}
